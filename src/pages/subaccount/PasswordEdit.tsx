...
class PasswordEdit extends React.PureComponent<PasswordEditProps, any> {
  ...
  private onSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    this.props.form.validateFields((err, fieldsValue) => {
      ...
      this.props.dispatch({ type: 'subaccount/password', payload: fieldsValue });
      // this.props.dispatch({ type: 'subaccount/passwordSuccess@Promise' }).then(() => {
...
interface PasswordEditProps extends ReduxProps, LangSiteState, FormComponentProps {
  editingItem?: any;
  saving: boolean;
  onSuccess: () => void;
}

export default Form.create()(PasswordEdit)
